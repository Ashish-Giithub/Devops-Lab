...
class Consumer:
    ...
    def run(self):
        ...
        if data:
            frame, detections = self.draw_poses(data)
...
if __name__ == "__main__":
    camera_id = 2273  # Make sure this matches what your producer is using
    ...
    while True:
        ...
        if frame is not None:
            ...
            # ✅ We already draw skeletons/keypoints inside draw_poses()
            # So no need to draw bounding boxes here.
