...
class TokenManager:
    ...
    def get_play_token_graphql(self, stream_id):
        ...
        if response.status_code == 200:
            ...
            if 'errors' in data:
                logger.error(
                    f"GraphQL token retrieval failed: {data['errors']}")
    ...
    def get_play_token(self, stream_id):
        ...
        return retry_with_backoff(token_operation, operation_name=f"token retrieval for stream {stream_id}")